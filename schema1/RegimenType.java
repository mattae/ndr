...
public class RegimenType {
    ...
    public boolean equals(Object o) {
        ...
        return getVisitDate().equals(that.getVisitDate()) &&
                getPrescribedRegimen().equals(that.getPrescribedRegimen());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getVisitDate(), getPrescribedRegimen());
    }
}
